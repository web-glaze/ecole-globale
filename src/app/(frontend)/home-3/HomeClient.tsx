    ...
    <>
      <main className="font-urbanist">
              ...
              <div className="absolute inset-0 z-20 hidden lg:flex items-center pointer-events-none">
                <div className="container mx-auto flex justify-end">
                  <div className="pointer-events-auto w-full max-w-md bg-white p-8 shadow-2xl backdrop-blur">
                    <h3 className="mb-6 text-center font-urbanist text-3xl font-bold text-gray-700">ENQUIRE NOW</h3>
                    <EnquiryForm />
                  </div>
                </div>
              </div>
        ...
        <div id="enquire-now" className="md:hidden w-full max-w-md container mx-auto px-4 bg-white py-8 md:py-16">
          ...
          <h3 className="mb-4 text-3xl font-bold font-urbanist text-center bg-gradient-to-r from-[#171a20] via-[#e13e3e] to-[#171a20] bg-clip-text text-transparent">
            ENQUIRE NOW
          </h3>
          <EnquiryForm />
        </div>
        ...
        <section className="bg-gray-200 py-8 md:py-16">
          <div className="flex flex-col gap-12 container mx-auto px-4">
            <div className="md:text-center">
              <h5 className="text-2xl md:text-3xl mb-2 font-urbanist italic"> {welcome.smallHeading}</h5>
              <h3 className="text-3xl md:text-4xl font-bold font-urbanist mb-3 uppercase">{welcome.heading}</h3>
                ...
                <CarouselItem key={slide.id} className="basis-full md:basis-[45%] lg:basis-[30%] pr-3">
                  <div className="relative h-full flex flex-col">
                    ...
                    <Card className="w-full max-w-[270px] md:max-w-[400px] min-h-[250px] mx-auto relative z-10 py-8 px-5 text-center gap-0 rounded-none -mt-6 overflow-visible mb-2">
                      ...
                      <h3 className="text-xl mb-3 font-urbanist font-bold uppercase">{slide.title}</h3>
                      <h4 className="text-base">{slide.description}</h4>

                      {slide.buttonLink && (
                        <div className="mt-4">
                          <Link href={slide.buttonLink} className="font-urbanist inline-block border-b-2 border-black pb-1 text-base font-bold transition hover:border-primary">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              <Link href={`${featured[0]?.link}`} className="relative overflow-hidden md:col-span-2">
                ...
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[0]?.title}</h3>
              </Link>
              ...
              <Link href={`${featured[1]?.link}`} className="relative row-span-2 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/20" />
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[1].title}</h3>
              </Link>
              ...
              <Link href={`${featured[2]?.link}`} className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/20" />
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[2].title}</h3>
              </Link>
              <Link href={`${featured[3]?.link}`} className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/20" />
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[3].title}</h3>
              </Link>
              <Link href={`${featured[4]?.link}`} className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/20" />
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[4].title}</h3>
              </Link>
              <Link href={`${featured[5]?.link}`} className="relative col-span-2 overflow-hidden h-[220px] md:h-[320px]">
                ...
                <h3 className="absolute bottom-4 w-full text-center text-base px-2 text-shadow-lg uppercase font-urbanist text-white">{featured[5].title}</h3>
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-8 md:pt-16 pb-0">
          <div className="container mx-auto">
            <h3 className="mb-4 text-2xl font-bold font-urbanist text-center uppercase text-gray-500">{testimonialsSection.heading}</h3>
            <div className="pt-2">
              <Carousel
        ...
        <section className="bg-white py-8 md:pb-16 pt-0">
          <div className="container max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center justify-between">
            <div className="hidden md:block">
              <h3 className="font-urbanist text-2xl md:text-5xl leading-14 font-bold tracking-tight mb-5">{updatesSection?.heading}</h3>
            ...
            <div className="relative ">
              <h3 className="text-2xl font-bold font-urbanist text-center">Updates & Press Release</h3>
              <Carousel
                className=""
                setApi={setVideoApi}
                opts={{
        ...
        <section className="bg-white py-8 pb-24 overflow-hidden">
          <div className="container mx-auto px-4">
            <h3 className="text-2xl md:text-3xl font-bold font-urbanist text-center">{accolades?.heading || "Ecole Globale Accolades"} </h3>
